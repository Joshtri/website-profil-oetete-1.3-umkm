...
function tampilkanBerita() {
    fetch('https://api.allorigins.win/get?url=' + encodeURIComponent('https://www.antaranews.com/rss/hiburan.xml'))
        ...
        .then(data => {
            ...
            items.forEach(item => {
                ...
                document.getElementById('berita-hiburan-container').innerHTML += beritaHtml;
            });
        })
